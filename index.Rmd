...
uo %>% 
  ...
  # scale_color_manual(values = c("#6a1f25", "#387448", "#7fb7b7", "#669b3e", "#ddca72", "#7f5d47")) +
  labs(title = "Scatterplot of Teaching GEs' FTE and Average Undergraduate Course Credit",
       x = "GE Teaching FTE",
...
uo %>% 
  ...
  stat_regline_equation() +
  # scale_color_manual(values = c("#6a1f25", "#387448", "#7fb7b7", "#669b3e", "#ddca72", "#7f5d47")) +
  labs(title = "Scatterplot of Number of Teaching GEs and Average Undergraduate Course Credit",
